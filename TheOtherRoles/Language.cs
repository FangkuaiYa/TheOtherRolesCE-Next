...
public class Language
{
   private static TMPro.TMP_FontAsset FontJP = null, FontSC = null, FontKR = null;
    ...
    {
        return Assembly.GetExecutingAssembly().GetManifestResourceStream("TheOtherRoles.Resources.Lang.dat");
    }
    ...
    public static Stream GetBuiltinLanguageStream(string lang)
    {
        try
        {
            return Assembly.GetExecutingAssembly().GetManifestResourceStream("TheOtherRoles.Resources.Languages." + lang + ".dat");
        }
        catch
        {
            return null;
