...
namespace TheOtherRoles
{
	public class CustomOptionHolder
	{
		...
		//Enable
		public static CustomOption twoBomberSpawnRate;
		//give
		...
		public static CustomOption juggernautKillCooldown;
		public static CustomOption juggernautReductionPerKill;
		...
		public static void Load()
		{
			...
			mafiaSpawnRate = CustomOption.Create(10, Types.Impostor, new TranslationInfo(ModTranslation.GetString("Opt-Mafia", 2), Janitor.color), rates, null, true);
			...
			twoBomberSpawnRate = CustomOption.Create(467, Types.Impostor, new TranslationInfo(ModTranslation.GetString("Opt-Bomber", 7), Bomber.color), true, null, true);
			bomber2SpawnRate = CustomOption.Create(8840, Types.Impostor, new TranslationInfo(ModTranslation.GetRoleName(RoleId.Bomber2) + ModTranslation.GetString("Opt-General", 87), Bomber2.color), rates, twoBomberSpawnRate);
			...
			bomberSpawnRate = CustomOption.Create(460, Types.Impostor, new TranslationInfo(ModTranslation.GetRoleName(RoleId.Bomber) + ModTranslation.GetString("Opt-General", 87), Bomber.color), rates, twoBomberSpawnRate);
			...
			survivorSpawnRate = CustomOption.Create(20280, Types.Neutral, new TranslationInfo(RoleId.Survivor, Survivor.color), rates, null, true);
			survivorVestEnable = CustomOption.Create(20281, Types.Neutral, new TranslationInfo("Opt-Survivor", 1), true, survivorSpawnRate);
			survivorVestNumber = CustomOption.Create(20282, Types.Neutral, new TranslationInfo("Opt-Survivor", 2), 5f, 1f, 20f, 1f, survivorVestEnable);
			survivorVestCooldown = CustomOption.Create(20283, Types.Neutral, new TranslationInfo("Opt-Survivor", 3), 20f, 2.5f, 60f, 2.5f, survivorVestEnable);
			survivorVestDuration = CustomOption.Create(20284, Types.Neutral, new TranslationInfo("Opt-Survivor", 4), 10f, 2.5f, 60f, 2.5f, survivorVestEnable);
			survivorVestResetCooldown = CustomOption.Create(20285, Types.Neutral, new TranslationInfo("Opt-Survivor", 5), 5f, 2.5f, 60f, 2.5f, survivorVestEnable);
			survivorBlanksEnable = CustomOption.Create(20286, Types.Neutral, new TranslationInfo("Opt-Survivor", 6), false, survivorSpawnRate);
			survivorBlanksCooldown = CustomOption.Create(20287, Types.Neutral, new TranslationInfo("Opt-Survivor", 7), 20f, 5f, 60f, 2.5f, survivorBlanksEnable);
			survivorBlanksNumber = CustomOption.Create(20288, Types.Neutral, new TranslationInfo("Opt-Survivor", 8), 6f, 1f, 20f, 1f, survivorBlanksEnable);
			...
			swooperKillCooldown = CustomOption.Create(1115, Types.Neutral, new TranslationInfo("Opt-Swooper", 5), 30f, 10f, 60f, 5f, swooperSpawnRate);
			...
			swooperSpeed = CustomOption.Create(1115, Types.Neutral, new TranslationInfo("Opt-Swooper", 6), 1.5f, 0.5f, 2f, 0.5f, swooperSpawnRate);

			juggernautSpawnRate = CustomOption.Create(1400, Types.Neutral, new TranslationInfo(RoleId.Juggernaut, Juggernaut.color), rates, null, true);
			juggernautKillCooldown = CustomOption.Create(1401, Types.Neutral, new TranslationInfo("Opt-Juggernaut", 1), 30f, 10f, 60f, 2.5f, juggernautSpawnRate);
			juggernautReductionPerKill = CustomOption.Create(1402, Types.Neutral, new TranslationInfo("Opt-Juggernaut", 2), 5f, 2.5f, 10f, 2.5f, juggernautSpawnRate);
			juggernautCanVent = CustomOption.Create(1403, Types.Neutral, new TranslationInfo("Opt-Juggernaut", 3), false, juggernautSpawnRate);

			plagueDoctorSpawnRate = CustomOption.Create(6000, Types.Neutral, new TranslationInfo(RoleId.PlagueDoctor, PlagueDoctor.color), rates, null, true);
			plagueDoctorInfectCooldown = CustomOption.Create(6001, Types.Neutral, new TranslationInfo("Opt-PlagueDoctor", 1), 10f, 2.5f, 60f, 2.5f, plagueDoctorSpawnRate, false);
			plagueDoctorNumInfections = CustomOption.Create(6002, Types.Neutral, new TranslationInfo("Opt-PlagueDoctor", 2), 1f, 1f, 3f, 1f, plagueDoctorSpawnRate, false);
			plagueDoctorDistance = CustomOption.Create(6003, Types.Neutral, new TranslationInfo("Opt-PlagueDoctor", 3), 1f, 0.25f, 5f, 0.25f, plagueDoctorSpawnRate, false);
			plagueDoctorDuration = CustomOption.Create(6004, Types.Neutral, new TranslationInfo("Opt-PlagueDoctor", 4), 5f, 1f, 30f, 1f, plagueDoctorSpawnRate, false);
			plagueDoctorImmunityTime = CustomOption.Create(6005, Types.Neutral, new TranslationInfo("Opt-PlagueDoctor", 5), 10f, 1f, 30f, 1f, plagueDoctorSpawnRate, false);
			plagueDoctorInfectKiller = CustomOption.Create(6006, Types.Neutral, new TranslationInfo("Opt-PlagueDoctor", 6), true, plagueDoctorSpawnRate);
			plagueDoctorWinDead = CustomOption.Create(5999, Types.Neutral, new TranslationInfo("Opt-PlagueDoctor", 7), true, plagueDoctorSpawnRate);
            ...
            lawyerIsProsecutorChance = CustomOption.Create(615, Types.Neutral, new TranslationInfo("Opt-Lawyer", 7, Lawyer.color), rates, lawyerSpawnRate);
			...
			lawyerStolenWin = CustomOption.Create(358, Types.Neutral, new TranslationInfo("Opt-Lawyer", 8), true, lawyerSpawnRate);
			...
			cupidSpawnRate = CustomOption.Create(9050, Types.Neutral, new TranslationInfo(RoleId.Cupid, Cupid.color), rates, null, true);
			cupidTimeLimit = CustomOption.Create(9051, Types.Neutral, new TranslationInfo("Opt-Cupid", 1), 300f, 30f, 1200f, 30f, cupidSpawnRate, false);
			cupidShield = CustomOption.Create(9052, Types.Neutral, new TranslationInfo("Opt-Cupid", 2), true, cupidSpawnRate);
			...
			snitchLeftTasksForReveal = CustomOption.Create(211, Types.Crewmate, new TranslationInfo("Opt-Snitch", 1), 1f, 0f, 10f, 1f, snitchSpawnRate);
			snitchSeeMeeting = CustomOption.Create(212, Types.Crewmate, new TranslationInfo("Opt-Snitch", 2), true, snitchSpawnRate);
			snitchCanSeeRoles = CustomOption.Create(213, Types.Crewmate, new TranslationInfo("Opt-Snitch", 3), false, snitchSpawnRate);
			snitchIncludeNeutralTeam = CustomOption.Create(214, Types.Crewmate, new TranslationInfo("Opt-Snitch", 4), new[] { new TranslationInfo("Opt-General", 10), new TranslationInfo("Opt-Snitch", 5), new TranslationInfo("Opt-Snitch", 6), new TranslationInfo("Opt-Snitch", 7) }, snitchSpawnRate);
			snitchTeamNeutraUseDifferentArrowColor = CustomOption.Create(215, Types.Crewmate, new TranslationInfo("Opt-Snitch", 8), true, snitchIncludeNeutralTeam);
			...
			modifierTorch = CustomOption.Create(1102, Types.Modifier, new TranslationInfo(RoleId.Torch, Color.yellow), rates, null, true);
			modifierTorchQuantity = CustomOption.Create(1103, Types.Modifier, new TranslationInfo("Opt-Torch", 1, Color.yellow), ratesModifier, modifierTorch);

			modifierRadar = CustomOption.Create(1101, Types.Modifier, new TranslationInfo(RoleId.Radar, Color.yellow), rates, null, true);
			...
			restrictDevices = CustomOption.Create(1101, Types.General, new TranslationInfo("Opt-General", 72), new[] { new TranslationInfo("Opt-General", 9), new TranslationInfo("Opt-General", 73), new TranslationInfo("Opt-General", 74) }, null, false);
